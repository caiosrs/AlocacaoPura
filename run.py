...
def get_local_ip():
    ...
    try:
        ...
        ip = '127.0.0.1'  # se tdo der errado, usa ip o localhost
    finally:
        s.close()
    return ip 

def main():
    os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'alocacao_pura.settings')
    ...
    try:
        ...
        execute_from_command_line(['manage.py', 'runserver', f'{local_ip}:8002', '--noreload'])
